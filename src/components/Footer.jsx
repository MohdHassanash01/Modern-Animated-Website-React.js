...
function Footer() {
  return (
    <div className='w-full h-screen bg-white p-16 flex gap-5 border-t-2 border-gray-300'>
      <div className='w-1/2 h-full  flex flex-col justify-between'>

      <div className='heading text-black'>

      <h1 className='text-9xl uppercase leading-none -mb-7 font-semibold'>Eye-</h1>

<h1 className='text-9xl uppercase leading-none  -mb-7  font-semibold'>Opening</h1>
      </div>
      ...
      <h1 className='text-6xl uppercase leading-none -mb-10 font-semibold'>Presentations

      <div className='dets text-[16px] mt-10 font-normal'>
        <a className='block mt-2' href="">S:</a>
        <br />

        <a className='block mt-4 underline' href="#">Facebook</a>

        <a className='block mt-4 underline' href="#">Instagram</a>
        
        <a className='block mt-4 underline' href="#">Twitter</a>

        <a className='block mt-4 underline' href="#">Linkedin</a>

        <a className='block mt-4 underline' href="#">Behance</a>



        <a className='block mt-7 underline' href="#">L:</a>
        <br />
        
        <a className='block mt-4 underline' href="#">202-1965 W 4th Ave</a>

        <a className='block mt-4 underline' href="#">Vancouver, Canada</a>

        <br />

        <a className='block mt-4 underline' href="#">30 Chukarina St</a>

       <a className='block mt-4 underline' href="#">Lviv, Ukraine</a> 

<br />
<br />

<a className='block mt-4 underline' href="#">E:</a>

<a className='block mt-4 underline' href="#">hello@ochi.design</a> 
